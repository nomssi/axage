CLASS ycl_axage_thing DEFINITION INHERITING FROM ycl_axage
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS new
      IMPORTING !type              TYPE tv_type   DEFAULT c_type_thing
                repository         TYPE REF TO ycl_axage_repository
                !name              TYPE clike
                descr              TYPE clike
    ...
    METHODS attributes
      IMPORTING can_be_pickup      TYPE abap_bool
